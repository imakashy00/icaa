...
class PatientDetails(BaseModel):
    ...
    relationship_to_policy_holder: Optional[str]
    gender: Optional[str]
    age: Optional[int]
...
class DiagnosisAndTreatment(BaseModel):
    ...
    pre_authorization: Optional[PreAuthorization]
    injury_details: Optional[InjuryDetails]
...
class ClaimForm(BaseModel):
    primary_insured: Optional[PrimaryInsured]
    insurance_history: Optional[InsuranceHistory]
    patient_details: Optional[PatientDetails]
    hospitalization_details: Optional[HospitalizationDetails]
    claim_expenses: Optional[ClaimExpenses]
    benefits: Optional[BenefitDetails]
    document_checklist: Optional[DocumentChecklist]
    hospital_details: Optional[HospitalDetails]
    diagnosis_and_treatment: Optional[DiagnosisAndTreatment]
